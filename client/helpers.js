...
UI.registerHelper('momentImage1', function(options) {
    if(options.hash.recipe) {
        return '/img/recipes/' + DIMENSIONS['small'] + '/' + options.hash.recipe.name + 'm1' + '.jpg';
    }
});

UI.registerHelper('momentImage2', function(options) {
    if(options.hash.recipe) {
        return '/img/recipes/' + DIMENSIONS['small'] + '/' + options.hash.recipe.name + 'm2' + '.jpg';
    }
});
